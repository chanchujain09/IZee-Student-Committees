            ...
            {committee.whatWeDo.map((item, index) => {
              ...
              return (
                <div key={index} className="relative flex flex-col items-center group mt-4 lg:mt-0">
                  ...
                  {/* Main Card */}
                  <div className="bg-white rounded-3xl shadow-sm w-full relative z-10 flex flex-col items-center p-8 text-center h-full border border-slate-100 transition-transform duration-500 group-hover:-translate-y-1">
